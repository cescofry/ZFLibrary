...
//  UIImage+Tools.m
//
//  Created by Francesco Frison on 26/09/2011.
//  Copyright (c) 2012 MPme.com. All rights reserved.
//
...
+ (UIImage *)imageOfSize:(CGSize)size withColor:(UIColor *)color {
	UIGraphicsBeginImageContextWithOptions(size, 1, 0);
...
- (UIImage *)scaleWithMaxWidth:(CGFloat)maxSize quality:(CGInterpolationQuality)quality {
    CGRect        bnds = CGRectZero;
    UIImage*      copy = nil;
    CGContextRef  ctxt = nil;
    CGRect        orig = CGRectZero;
